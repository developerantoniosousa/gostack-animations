...
export default class App extends Component {
  state = {
    ...
    userProgress: new Animated.Value(0),
    userSelected: null,
  ...
  selectUser = user => {
    this.setState({ userSelected: user }, () => {
      Animated.parallel([
        ...
        Animated.timing(this.state.userProgress, {
          toValue: 100,
          duration: 500
        })
      ]).start(() => {
        ...
        >
          <Animated.Image
            style={[styles.headerImage, {
              opacity: this.state.userProgress.interpolate({
                inputRange: [0, 100],
                outputRange: [0, 1],
              })
            }]}
          ...
          <Animated.Text
            style={[
              styles.headerText,
              {
                ...
                transform:[
                  {translateX: this.state.userProgress.interpolate({
                    inputRange: [0, 100],
                    outputRange: [0, screenWidth]
                  })}
                ],
